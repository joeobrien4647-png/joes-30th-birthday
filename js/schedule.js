...
const ACTIVITIES = [
    {
        ...
        tip: 'Late April is perfect \u2014 vines are budding and the caves stay cool. Book a guided tour for the best experience.',
        link: 'https://www.domaine-huet.com',
        linkLabel: 'Domaine Huet',
        cost: { min: 26, max: 99 },
        duration: '2\u20134 hours',
        driveTime: '1h 15m',
    ...
    },
    {
        ...
        tip: 'Big commitment (full day) so best for the wine-lovers. Chinon town itself is great for a wander and lunch.',
        cost: { min: 30, max: 150 },
        duration: 'Full day',
        driveTime: '1h',
    ...
    },
    {
        ...
        tip: 'Combine with kayaking underneath for the ultimate day trip. The gardens are spectacular in late April.',
        link: 'https://www.chenonceau.com/en/',
    ...
    },
    {
        ...
        tip: 'Furthest drive but the most jaw-dropping. The rooftop terrace alone is worth it. E-bikes make the huge grounds manageable.',
        link: 'https://www.chambord.org/en/',
        linkLabel: 'Official Site',
        cost: { min: 16, max: 16 },
        duration: '2\u20134 hours',
        driveTime: '1h 45m',
    ...
    },
    {
        ...
        tip: 'Best value ch\u00e2teau for the gardens alone. The maze is a laugh. Could pair with Azay-le-Rideau (20 min apart).',
        link: 'https://www.chateauvillandry.fr/en/',
        linkLabel: 'Official Site',
        cost: { min: 7, max: 12 },
        duration: '2\u20133 hours',
        driveTime: '1h 10m',
    ...
    },
    {
        ...
        tip: 'Cheapest ch\u00e2teau and still gorgeous. Quick visit \u2014 could double up with Villandry in one afternoon.',
        link: 'https://www.azay-le-rideau.fr/en/',
        linkLabel: 'Official Site',
        cost: { min: 9, max: 11 },
    ...
    },
    {
        ...
        tip: 'Priciest option but a once-in-a-lifetime thing. Weather dependent \u2014 they cancel if it\'s windy. Book early.',
    ...
    },
    {
        ...
        tip: 'The Instagram shot of the trip. Visit the ch\u00e2teau first, then kayak under it \u2014 makes for an incredible day.',
        cost: { min: 15, max: 40 },
    ...
    },
    {
        ...
        tip: 'Dead flat so no fitness worries. E-bikes available. Could combine with a ch\u00e2teau stop along the way.',
        link: 'https://www.loireavelo.fr/en/',
        linkLabel: 'Loire \u00e0 V\u00e9lo',
        cost: { min: 15, max: 45 },
    ...
    },
    {
        ...
        tip: 'Works best as a morning activity for a smaller group. The rest can chill by the pool.',
        cost: { min: 60, max: 150 },
        duration: '2\u20136 hours',
    ...
    },
    {
        ...
        description: 'Les Halles de Tours is a feast for the senses \u2014 local cheeses (Sainte-Maure-de-Touraine), rillettes de Tours, fresh produce, wines, and pastries. Open Wed and Sat mornings. Tours is an "International City of Gastronomy."',
        tip: 'Open Wed and Sat mornings \u2014 we land on a Wed and Sat is PopWorld day, so Thu or Fri would need a separate trip to Tours.',
        cost: { min: 0, max: 50 },
        duration: '2\u20133 hours',
        driveTime: '1h 15m',
    ...
    },
    {
        ...
        tip: 'A surprisingly fun morning out. The cheese you taste is nothing like supermarket stuff. Good for non-drinkers too.',
        cost: { min: 20, max: 50 },
        duration: '2\u20133 hours',
        driveTime: '45m \u2014 1h',
    ...
    },
    {
        ...
        tip: 'Absolute scenes guaranteed. Competitive people will love this. Works in groups of 8\u201312 so we\'d rotate.',
        link: 'https://www.battlekart.com',
        linkLabel: 'BattleKart',
        cost: { min: 22, max: 22 },
        duration: '1\u20132 hours',
        driveTime: '1h 15m',
    ...
    },
    {
        ...
        description: 'Outdoor karting track with 270cc adult karts PLUS a 4,000m\u00B2 paintball zone. Group packages bundle both activities. Perfect for a team showdown. Includes bar, clubhouse, and picnic area.',
        tip: 'Two activities in one spot. Pricey but a proper half-day out. The paintball is brutal in a good way.',
        cost: { min: 55, max: 70 },
        duration: '2\u20134 hours',
        driveTime: '1h 15m',
    ...
    },
    {
        ...
        tip: 'Cheap and spectacular but it\'s a 1h30 drive and doesn\'t start until 10pm. Best for a quieter evening.',
        cost: { min: 9, max: 14 },
    ...
    },
    {
        ...
        tip: 'The weird and wonderful option. Unlike anything you\'ve seen before. Quick visit \u2014 pair with a wine stop.',
        cost: { min: 5, max: 8 },
    ...
    },
    {
        ...
        tip: 'Our local option \u2014 15 minutes away. Great fallback if weather changes plans. Multiple activities at once.',
        cost: { min: 10, max: 25 },
        duration: 'Half to full day',
        driveTime: '15 min',
        ...
        grid.innerHTML = sorted.map(act => {
            ...
            return `<div class="av-card${isCancelled ? ' av-cancelled' : ''}${isBooked ? ' av-booked' : ''}${act.highlight ? ' av-highlight' : ''}" data-id="${act.id}">
                ...
                <div class="av-card-details" id="av-details-${act.id}" style="display:none;">
                    ...
                    ${act.tip ? `<p class="av-card-tip">\uD83D\uDCA1 ${escapeHtml(act.tip)}</p>` : ''}
                    <div class="av-card-meta">
                        <span>\uD83D\uDC65 ${escapeHtml(act.groupFit)}</span>
                        ${paired ? `<span>\uD83D\uDD17 Pairs with: ${escapeHtml(paired.name)}</span>` : ''}
                        ${act.link ? `<a href="${act.link}" target="_blank" rel="noopener" class="av-card-link">\uD83C\uDF10 ${escapeHtml(act.linkLabel || 'Website')}</a>` : ''}
                    </div>
                </div>
